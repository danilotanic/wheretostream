...
const CommandDialog = ({
  ...
  return (
    <Dialog {...props}>
      <DialogContent className="overflow-hidden !rounded-[21px] p-0 shadow-lg wrapper  lg:max-w-3xl max-w-[calc(100%-48px)]">
        <Command
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Input
    ref={ref}
    className={cn(
      "flex h-11 w-full bg-transparent py-1.5 h-10 text-sm outline-none placeholder:text-neutral-500 disabled:cursor-not-allowed disabled:opacity-50 dark:placeholder:text-neutral-400",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ref={ref}
    className={cn(
      "relative group flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none aria-selected:text-neutral-900 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 dark:aria-selected:bg-neutral-800 dark:aria-selected:text-neutral-50",
      className
    )}
    {...props}
  />
...
const CommandLoading = CommandLoadingPrimitive;
