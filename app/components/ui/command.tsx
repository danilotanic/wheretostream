...
const CommandDialog = ({
  ...
  return (
    <Dialog {...props}>
      <DialogContent className="overflow-hidden !rounded-[21px] p-0 shadow-lg wrapper lg:max-w-3xl max-w-[calc(100%-24px)]">
        <Command
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ref={ref}
    className={cn(
      "relative group flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none aria-selected:text-neutral-900 dark:aria-selected:bg-neutral-800 dark:aria-selected:text-neutral-50",
      className
    )}
    {...props}
  />
